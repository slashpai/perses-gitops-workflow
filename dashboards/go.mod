module github.com/slashpai/perses-gitops-workflow/dashboards

go 1.26.5

require (
	github.com/perses/community-mixins v0.0.0-20260821185245-947ffa15edb1
...
require (
	...
	github.com/perses/plugins/gaugechart v0.13.0 // indirect
